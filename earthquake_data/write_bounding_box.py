"""
Bounding Box Writer Module.

Creates the csv file for the geographical area.
"""
...
def create_bounding_box_csv():
    """
    Create a CSV file named 'bounding_box.csv' with geographic coordinates.
    ...
    This allows other parts of the program to read the configuration.
    """
    ...
    with open('bounding_box.csv', mode='w', newline='', encoding='utf-8'
              ) as csv_file:
